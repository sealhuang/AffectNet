    ...
    while True:
        ...
        while(image_count < batch_size and image_id < nb_train_samples):
            try:
                ...
                continuous_label = label_data[image_id-1][1:]
                batch_feature += [feature01]
                batch_labels += [img_label]
                batch_continuous_labels += [continuous_label]
        ...
        batch_continuous_labels = np.array(batch_continuous_labels)
        ...
        yield (batch_feature,[batch_labels,batch_continuous_labels])


def val_generator():
    #full_image_dir = 'keras_data/full_image/train'
    img_dir = '../data_affect_net/val'
    label_file = mat_load.loadmat('val_labels')
